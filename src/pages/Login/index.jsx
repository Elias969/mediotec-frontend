...
const Index = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#201AE8]">
      <div className="flex flex-row items-center justify-center w-full max-w-4xl space-x-8">
        <img
        ...
        <div className="w-1/2">
          <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-between">
              <button
                className="bg-[#630FFF] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="submit"
              >
                Entrar
              </button>
